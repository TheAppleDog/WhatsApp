...
public class CustomAdapter2 extends BaseAdapter {
    ...
    public CustomAdapter2(Context applicationContext, String[] FriendsList, String[] Status, int[] profile) {
    ...
    public View getView(int i, View v, ViewGroup viewGroup) {
        v = inflater.inflate(R.layout.fragment_third,null);
